	...
	$.ajax({
		...
		success : function(data, textStatus, jqXHR) {
			...
			for (var i = 0; i < len; ++i) {
				...
				list.append("<li><a onclick=GetItem(" + item.i_id + ",true)>" + "<img src='" + item.i_img + "'/>" + "<p id='info'>" + item.i_name + "</p>" + "<p class='ui-li-aside'> $" + item.i_price + "</p>" +  "<p class='ui-li-aside'> $" + item.i_price + "</p>" + "</a></li>");
			}
